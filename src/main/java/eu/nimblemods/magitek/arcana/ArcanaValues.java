...
public class ArcanaValues
{
    ...
    private static final ArcaneItemWrapper[] ARCANA_VALUES = {FEATHER, REED, STONE, COAL, GHAST_TEAR, DIAMOND, ENDER_PEARL, BLAZE_ROD};
    ...
    public static ArcaneItemWrapper getArcana(ItemStack itemStack)
    {
        ...
        {
            return getArcana(itemStack.getItem());
        }
    }

    public static ArcaneItemWrapper getArcana(Item item)
    {
        if(item == null)
        {
            return null;
        }
        int i = findItemInArcana(item);
